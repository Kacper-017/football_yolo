...
class Tracker:
    ...
    def interpolate_ball_positions(self, ball_positions):
        """Interpolates missing ball positions by linear interpolation

        Args:
            ball_positions (_type_): _description_

        Returns:
            _type_: interpolated ball positions
        """
    ...
    def get_object_tracks(self, frames, read_from_stub=False, stub_path=None):
        ...
        if read_from_stub & (stub_path is not None) & Path(stub_path).exists():
        ...
        for frame_num, detection in enumerate(detections):
            ...
            # {frame_num: {track_id: {"bbox": [x1,y1,x2,y2]}}}
    ...
    def draw_traingle(self, frame, bbox, color: tuple):
        """Draws a triangle above the bbox, used to indicate player with ball and the ball.
